...
export const waterPlantLogic = (
  ...
  const updatedPlant: PlantModel = {
    ...
    nextWateringDate: calculateNext(
      newLastWateredDateISO,
      targetPlant.wateringIntervalDays
    ),
  }
...
export const updatePlantLogic = (
  state: PlantsState,
  updatedPlant: PlantModel
): Partial<PlantsState> => {
  return {
